...
export class GunFamilyDefinition extends FamilyDefinition<Record<string, GunMember>> {
  ...
  readonly members = {
    ...
    splitterRifle: {
      ...
      levels: [
        level(1,{fireRatePerSecond:1.15,damage:.8,projectileSpeed:585,projectileRadius:2.75,projectileCount:2,spreadDegrees:2.5,trailLength:14,muzzleFlashScale:.65,hitFlashScale:.65}),
        level(2,{fireRatePerSecond:1.35,damage:.95,projectileSpeed:625,projectileRadius:2.85,projectileCount:2,spreadDegrees:3,trailLength:15,muzzleFlashScale:.7,hitFlashScale:.7}),
        level(3,{fireRatePerSecond:1.55,damage:1.05,projectileSpeed:665,projectileRadius:3,projectileCount:2,spreadDegrees:3.5,trailLength:16,muzzleFlashScale:.75,hitFlashScale:.75}),
      ],
    },
