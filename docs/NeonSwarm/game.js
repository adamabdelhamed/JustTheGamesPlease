...
var familyShapeIds = ["triad-pod", "bruiser-hex", "hex-fighter", "orbit-drone", "trick-diamond", "elite-star"];
...
var TrackMenuRenderer = class _TrackMenuRenderer {
  ...
  #addBackground(primitives, time) {
    ...
    primitives.push({ x: -78, y: 126, width: 118, height: 118, color: "#20eaff", secondaryColor: "#29133f", glow: 0.9, intensity: 0.42, texture: 0.18, rimIntensity: 1.1, shadowStrength: 0.42, shape: "orb" });
    primitives.push({ x: 430, y: 150, width: 46, height: 46, color: "#4b86ff", secondaryColor: "#ff3bd5", glow: 1.2, intensity: 0.72, arcStart: -2.75, arcEnd: 2.75, shape: "arc" });
  ...
  #addFamily(family, familyIndex, primitives, shapes, time) {
    ...
    const intensity = family.unlocked ? trackMenuTuning.idleEnergy : trackMenuTuning.lockedEnergy;
    const glow = family.unlocked ? trackMenuTuning.idleGlow : trackMenuTuning.lockedGlow;
    const panelPoints = [
      [x + cut, y],
      [x + width - cut, y],
      [x + width, y + cut],
    ...
    shapes.push({
      shape: requiredShape2(family.shapeId),
      x: trackMenuTuning.emblemX + emblemWobble.x,
      y: y + 62 + emblemWobble.y,
      size: trackMenuTuning.emblemSize * emblemWobble.scale,
      color: family.accent,
      ...
      energySpeed: 1.1,
      energyBleed: 0.55,
      opacity: family.unlocked ? 1 : 0.54
    });
  ...
  #addTrackNode(family, track, primitives, shapes, time) {
    ...
    const energy = track.unlocked ? hovered ? trackMenuTuning.hoverEnergy : trackMenuTuning.idleEnergy : trackMenuTuning.lockedEnergy;
    const glow = track.unlocked ? hovered ? trackMenuTuning.hoverGlow : trackMenuTuning.idleGlow : trackMenuTuning.lockedGlow;
