...
var playGunFire = (gunId) => playRotatedSfx(gunFireSoundIds[gunId], 3);
var playSwordSwing = (swordId) => playRotatedSfx(swordSwingSoundIds[swordId], 3);
var playPickup = (id) => {
