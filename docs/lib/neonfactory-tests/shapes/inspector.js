...
try {
  ...
  const render = (now) => {
    ...
    readout.textContent = `${actor.shape.family.toUpperCase()} \xB7 ${actor.shape.rock} \xB7 rotation ${currentRotationLabel} \xB7 position ${actor.x.toFixed(2)}, ${actor.y.toFixed(2)}`;
